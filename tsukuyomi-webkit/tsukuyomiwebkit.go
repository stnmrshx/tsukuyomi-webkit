...
func (v *WebView) SetMaintainsBackForwardList(flag bool) {
	C.webkit_web_view_set_maintains_back_forward_list(
		v.getWebView(),
		bool2gboolean(flag))
}
...
func (v *WebView) GoBackOrForward(steps int) {
	C.webkit_web_view_go_back_or_forward(
		v.getWebView(),
		C.gint(steps))
}
...
func (v *WebView) LoadString(content, mime_type, encoding, base_uri string) {
	...
	C.webkit_web_view_load_string(
		v.getWebView(),
		C.to_gcharptr(pcontent),
		C.to_gcharptr(pmime_type),
		C.to_gcharptr(pencoding),
		C.to_gcharptr(pbase_uri))
}
...
func (v *WebView) LoadHtmlString(content, base_uri string) {
	...
	pbase_uri := C.CString(base_uri)
	defer C.free_string(pbase_uri)
	C.webkit_web_view_load_html_string(
		v.getWebView(),
		C.to_gcharptr(pcontent),
		C.to_gcharptr(pbase_uri))
}
...
func (v *WebView) SetHighlightTextMatches(highlight bool) {
	C.webkit_web_view_set_highlight_text_matches(
		v.getWebView(),
		bool2gboolean(highlight))
}
...
func (v *WebView) SetEditable(flag bool) {
	C.webkit_web_view_set_editable(
		v.getWebView(),
		bool2gboolean(flag))
}
...
func (v *WebView) SetSettings(settings *WebSettings) {
	C.webkit_web_view_set_settings(
		v.getWebView(),
		C.to_WebKitWebSettings(settings.Object))
}
...
func (v *WebView) SetTransparent(flag bool) {
	C.webkit_web_view_set_transparent(
		v.getWebView(),
		bool2gboolean(flag))
}
...
func (v *WebView) SetZoomLevel(zoom_level float64) {
	C.webkit_web_view_set_zoom_level(
		v.getWebView(),
		C.gfloat(zoom_level))
}
...
func (v *WebView) SetFullContentZoom(full_content_zoom bool) {
	C.webkit_web_view_set_full_content_zoom(
		v.getWebView(),
		bool2gboolean(full_content_zoom))
}
...
func (v *WebView) SetViewSourceMode(view_source_mode bool) {
	C.webkit_web_view_set_view_source_mode(
		v.getWebView(),
		bool2gboolean(view_source_mode))
}
...
func (v *WebFrame) LoadString(content, mime_type, encoding, base_uri string) {
	...
	pbase_uri := C.CString(base_uri)
	defer C.free_string(pbase_uri)
	C.webkit_web_frame_load_string(
		v.getWebFrame(),
		C.to_gcharptr(pcontent),
		C.to_gcharptr(pmime_type),
		C.to_gcharptr(pencoding),
